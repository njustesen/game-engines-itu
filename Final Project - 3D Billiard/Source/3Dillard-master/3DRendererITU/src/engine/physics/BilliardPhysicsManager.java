...
public class BilliardPhysicsManager extends PhysicsManager{
	...
	public BilliardPhysicsManager(int iterationsPerSecond){
		
		balls = new ArrayList<BilliardBall>();
		//this.iterationsPerSecond = iterationsPerSecond;
		this.iterationsPerSecond = 1;
	...
	public void moveBalls(double ms){
		...
		for(BilliardBall ball : balls){
			...
			// Move ball - in cm/s
			ball.move(ball.getVelocity().multiply( sec * 100 ));
